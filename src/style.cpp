...
void Style::SetStyle(ImGuiStyle &_style)
{
    imgui_style = &_style;
...
void Style::_set_dark()
{
    ImGui::StyleColorsDark();
}

void Style::_set_light()
{
    ImGui::StyleColorsLight();
}

void Style::_set_forest()
{
    // Text
...
void Style::_set_catppuccin_mocha()
{
    // Text
